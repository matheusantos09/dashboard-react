...
use App\Repository\TeamworkPm\TeamworkBuilder;
use Carbon\Carbon;
use Exception;
...
class Project
{
    ...
    public static function getAllProjectsTime()
    {
        ...
        foreach ($projectsAll['projects'] as $project) {
            ...
            $projectEntity = \App\Project::find($project['id']);
    ...
    {
        return \App\Project::find((int)$projectId);
    }
    ...
    public static function getAllProjectsSupportHours($request)
    {
        ...
        $projects = \App\Project::where('support_hours', '<>', null)
