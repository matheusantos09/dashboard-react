...
export default function PersistentDrawerLeft() {
    ...
    return (
        <nav className="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            {/*        <input className="form-control form-control-navbar" type="search" placeholder="Buscar clientes"*/}
            {/*               aria-label="Search" />*/}
            ...
            {/*        <a className="nav-link" data-toggle="dropdown" href={(e) => {*/}
            {/*            e.preventDefault()*/}
            {/*        }}>*/}
            ...
            {/*            <a href={(e) => {*/}
            {/*            e.preventDefault()*/}
            {/*        }} className="dropdown-item dropdown-footer">See All Messages</a>*/}
            {/*        </div>*/}
            {/*    </li>*/}
            {/*    <li className="nav-item dropdown">*/}
            {/*        <a className="nav-link" data-toggle="dropdown" href={(e) => {*/}
            ...
            {/*    </li>*/}
            {/*    <li className="nav-item">*/}
            {/*        <a className="nav-link" data-widget="control-sidebar" data-slide="true" href={(e) => {*/}
            {/*            e.preventDefault()*/}
            {/*        }}>*/}
